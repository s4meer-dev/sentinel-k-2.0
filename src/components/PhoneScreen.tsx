...
export const PhoneScreen: React.FC<PhoneScreenProps> = ({ 
  ...
  return (
    <div className="relative w-full h-full bg-[#FAFAF8] text-[#090D15] flex flex-col justify-between select-none overflow-hidden font-sans">
      ...
      <div className="px-3 py-1 flex justify-between items-center border-b border-black/[0.05] bg-white/85">
        <div className="flex items-center gap-1.5">
          ...
          <div>
            <div className="text-[7px] font-mono-code text-slate-500 uppercase tracking-wider flex items-center gap-1">
              <span>SLIDE 0{currentIdx + 1} / 05</span>
      ...
      {/* 3. Main Operational Diagnostic Body with Left/Right Tap Navigation */}
      <div className="relative px-3 py-1.5 flex-1 flex flex-col justify-center space-y-1.5 text-xs overflow-hidden">
        ...
        <AnimatePresence mode="wait">
          ...
          {phase === 'INCOMING' && (
            ...
            >
              <div className="p-2 rounded-xl bg-amber-50/90 border border-amber-300 shadow-2xs">
                <div className="flex items-center justify-between text-[9px] font-mono-code text-amber-950 font-black mb-1">
                  <span className="flex items-center gap-1">
                    <AlertTriangle className="w-3.5 h-3.5 text-amber-600" />
                    DISPATCH INTERCEPTED
                  </span>
                  <span className="px-1.5 py-0.2 rounded bg-amber-200 text-amber-950 border border-amber-400 text-[7px] font-black">
                    UNVERIFIED
                  </span>
                </div>
                <div className="text-[9.5px] text-slate-900 font-mono-code leading-relaxed font-semibold">
                  CLAIMED: <strong className="text-black font-black">SUPERVISOR REYNOLDS</strong> <br />
                  VOICE CLONE SUSPECT: <strong className="text-red-700 font-black">71% SIMILARITY</strong> <br />
                  COERCIVE URGENCY: <strong className="text-amber-900 font-black">8.9 / 10</strong>
                </div>
              </div>

              {/* Audio Waveform & Equalizer Animation */}
              <div className="p-2 rounded-xl bg-white border border-black/[0.08] shadow-2xs">
                <div className="flex items-center justify-between text-[8px] font-mono-code text-slate-600 uppercase font-black mb-1">
                  ...
                  <button 
                    ...
                    className="flex items-center gap-0.5 text-[7px] text-amber-800 font-bold hover:underline cursor-pointer"
                  >
                ...
                <div className="flex items-end justify-between h-5 px-1 py-0.5 bg-slate-900 rounded-md mb-1.5 gap-0.5">
                ...
                <div className="text-[9px] font-black text-slate-950 font-mono-code italic bg-[#F4F4F0] p-1.5 rounded-lg border border-black/[0.06]">
          ...
          {phase === 'EXTRACTING' && (
            <motion.div
              ...
              className="space-y-1.5"
            >
              <div className="p-2 rounded-xl bg-blue-50/90 border border-blue-300 shadow-2xs">
                <div className="flex items-center justify-between text-[9px] font-mono-code text-blue-950 font-black mb-1">
                  <span className="flex items-center gap-1">
                    <Cpu className="w-3.5 h-3.5 text-blue-600 animate-spin" />
                    SNAPDRAGON NPU (45 TOPS)
                  </span>
                  <span className="text-[7px] px-1.5 py-0.2 rounded bg-blue-200 text-blue-950 border border-blue-400 font-black">
                    18ms SLM
                  </span>
                </div>
              ...
              <div className="p-2 rounded-xl bg-white border border-black/[0.08] shadow-2xs">
                ...
                <div className="text-[8.5px] font-mono-code text-slate-950 bg-[#F4F4F0] p-1.5 rounded-lg border border-black/[0.06] space-y-0.5">
          ...
          {phase === 'CYBER_CHECK' && (
            <motion.div
              ...
              className="space-y-1.5"
            >
              <div className="p-2 rounded-xl bg-emerald-50/90 border border-emerald-300 shadow-2xs">
                <div className="flex items-center justify-between text-[9px] font-mono-code text-emerald-950 font-black mb-1">
                  <span className="flex items-center gap-1">
                    <ShieldCheck className="w-3.5 h-3.5 text-emerald-600" />
                    CYBER GATE: 100% VALID
                  </span>
                  <span className="text-[7px] px-1.5 py-0.2 rounded bg-emerald-200 text-emerald-950 border border-emerald-400 font-black">
                    LOGIC PASS
                  </span>
                </div>
                <div className="text-[9.5px] text-slate-900 font-mono-code space-y-0.5 font-semibold">
              ...
              <div className="p-2 rounded-xl bg-amber-50/90 border border-amber-300 shadow-2xs">
                <div className="text-[8.5px] font-mono-code text-amber-950 font-black flex items-center gap-1">
                  <Zap className="w-3 h-3 text-amber-600" />
                  <span>THE KINETIC BLINDSPOT:</span>
                </div>
                <div className="text-[9.5px] text-slate-900 font-mono-code mt-0.5 font-semibold leading-tight">
                  Firewall allows write. Traditional cyber is blind to water hammer dynamics. EPANET physics twin spinning up...
                </div>
              </div>
            </motion.div>
          )}
          ...
          {phase === 'PHYSICAL_SIM' && (
            <motion.div
              ...
              className="space-y-1.5"
            >
              <div className="p-2 rounded-xl bg-red-50/90 border border-red-300 shadow-2xs">
                <div className="flex items-center justify-between text-[9px] font-mono-code text-red-950 font-black mb-1">
                  <span className="flex items-center gap-1">
                    <ShieldAlert className="w-3.5 h-3.5 text-red-600 animate-pulse" />
                    HYDRAULIC TWIN: VIOLATION
                  </span>
                  <span className="text-[7px] px-1.5 py-0.2 rounded bg-red-200 text-red-950 border border-red-400 font-black">
                    HARD REJECT
                  </span>
                </div>
                
                {/* SVG Pressure Surge Chart */}
                <div className="h-14 w-full bg-white rounded-lg p-1 border border-red-200 relative mb-1">
                  <div className="absolute top-1 left-1.5 text-[7px] font-mono-code font-bold text-red-700 flex items-center gap-1">
                    <TrendingUp className="w-2.5 h-2.5" />
                    <span>SURGE TRAJECTORY (T+42s)</span>
                  </div>
                  <div className="absolute top-1 right-1.5 text-[7px] font-mono-code font-bold text-red-600">
                    11.4 BAR PEAK
                  </div>

                  <svg viewBox="0 0 160 40" className="w-full h-full overflow-visible pt-2">
                    {/* Limit Line 9.2 Bar */}
                ...
                <div className="text-[9px] text-slate-900 font-mono-code space-y-0.5 font-semibold">
                  <div className="flex justify-between">
              ...
              <div className="p-1.5 rounded-xl bg-white border border-red-200 shadow-2xs text-[8.5px] font-mono-code text-red-900 font-semibold">
          ...
          {(phase === 'REPLAN' || phase === 'APPROVED') && (
            ...
            >
              <div className="p-2 rounded-xl bg-emerald-50/90 border border-emerald-300 shadow-2xs">
                ...
                <div className="h-12 w-full bg-white rounded-lg p-1 border border-emerald-200 relative mb-1">
                  <div className="absolute top-1 left-1.5 text-[7px] font-mono-code font-bold text-emerald-700">
                    SAFE HYDRAULIC GRADIENT
                  </div>
                  <div className="absolute top-1 right-1.5 text-[7px] font-mono-code font-bold text-emerald-700">
                    7.4 BAR PEAK
                  </div>

                  <svg viewBox="0 0 160 35" className="w-full h-full overflow-visible pt-1">
              ...
              <div className="p-1.5 rounded-xl bg-white border border-black/[0.08] shadow-2xs text-[8.5px] font-mono-code text-slate-700 font-semibold">
